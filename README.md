...
```
npm create cloudflare@latest -- --template=cloudflare/templates/white-hill-40d9
```

A live public deployment of this template is available at [https://white-hill-40d9.templates.workers.dev](https://white-hill-40d9.templates.workers.dev)
